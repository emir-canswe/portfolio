      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {achievements.map((ach) => (
            <div
              key={ach.id}
              className="hud-glass hud-glass-hover rounded-2xl p-6 sm:p-7 border border-amber-500/30 flex flex-col justify-between hud-corner-brackets shadow-[0_0_25px_rgba(245,158,11,0.08)]"
            >
              <div>
                {/* Card Top */}
                <div className="flex items-center justify-between gap-3 mb-4">
                  ...
                  <div className="flex items-center gap-1.5 font-mono text-xs text-amber-300/90 bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/30">
                ...
                <div className="text-xs font-mono text-cyan-300/80 mb-4">
                  {ach.event[lang]}
                </div>
              ...
              <div className="pt-4 border-t border-slate-800 flex items-center justify-between text-xs font-mono">
                {ach.projectRef && (
                  <span className="flex items-center gap-1 text-slate-300">
                    Project: <span className="text-cyan-300 font-semibold">{ach.projectRef}</span>
                  </span>
                )}
